if (window.location.origin == "http://localhost") {
    var base_url = window.location.origin + "/project/allocation/";
    var local_path = window.location.origin + "/project/";
} else {
    var base_url = window.location.origin + "/project/";
