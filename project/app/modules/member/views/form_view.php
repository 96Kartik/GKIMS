...
echo form_dropdown('role',$options,$role_id, $extra = 'class="form-control" id="title1" disabled="disabled"');
...
echo form_dropdown('dept',$options,$dept_id, $extra = 'class="form-control" id="title" disabled="disabled"');
