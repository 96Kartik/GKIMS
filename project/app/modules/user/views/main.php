...
<div class="row">
    <div class="col-md-12">
         <a href="<?php echo base_url('user/create');?>" class="btn btn-primary pull-right"><i class="fa fa-plus"></i> <?php echo lang('add_page');?></a>
    </div>
</div>
					...
					<div class="row">
						<div class="col-md-6 col-lg-6 col-xs-12 col-md-12">
							<div class="form-group input-group">
								<input class="form-control" type="text" name="nameSearch__user" id="nameSearch__user" placeholder="<?php echo lang('department_placeholder');?>" />
								<span class="input-group-addon"><i class="fa fa-search"></i></span>
							</div>
						</div>
					</div>
					
					<div class="table-responsive list__user">
