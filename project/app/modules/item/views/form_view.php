...
echo $input_div_open;
echo form_label(lang('item_vendor_id') . $required, 'title');
$item_vendor_id = array(
    'name' => 'item_vendor_id',
    'class' => 'form-control',
    'id' => 'title',
	'disabled' => 'disabled',
    'placeholder' => lang('item_vendor_id'),
    'value' => (isset($record->item_vendor_id)) ? $record->item_vendor_id : set_value('item_vendor_id')
);
echo form_input($item_vendor_id);
echo form_error('item_vendor_id');
echo $input_div_close;
