...
<section class="content-header">
  <h5>
	<?php echo lang('item_management');?>
	<small>Control panel</small>
  </h5>
   <div class="col-md-6 pull-right">
         <a href="<?php echo base_url('item/create');?>" class="btn btn-primary pull-right"><i class="fa fa-plus"></i> <?php echo lang('add_page');?></a>
    </div>
  <ol class="breadcrumb">
	<li><a href="#"><i class="fa fa-dashboard"></i> <?php echo lang('dashboard');?></a></li>
	<li class=""><?php echo lang('item_management');?></li>
					...
					<div class="row">
						<div class="col-md-6 col-lg-6 col-xs-12 col-md-12">
							<div class="form-group input-group">
								<input class="form-control" type="text" name="nameSearch__item" id="nameSearch__item" placeholder="<?php echo lang('department_placeholder');?>" />
								<span class="input-group-addon"><i class="fa fa-search"></i></span>
							</div>
						</div>
					</div>
					
					<div class="table-responsive list__item">
