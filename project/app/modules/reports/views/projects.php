...
<!--<div class="row">
    <div class="col-md-12">
         <a href="<?php echo base_url('auditreport/create');?>" class="btn btn-primary pull-right"><i class="fa fa-plus"></i> <?php echo lang('add_page');?></a>
    </div>
</div>-->
...
<div class="row">
    <div class="col-lg-12">
			...
			<div class="loader-gif" id="loader" style="display:none;">
                ...
                <div class="box-body">
					<?php echo $table;?>
					<a href="<?php echo base_url('reports/project_csv');?>" class="btn btn-success "><i class="fa fa-fw fa-download"></i> <?php echo lang('export_csv');?></a>
				 </div><!-- /.box-body -->
              </div>
				</div>
