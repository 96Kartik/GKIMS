    ...
    <div class="col-lg-12">
			...
			<div class="loader-gif" id="loader" style="display:none;">
                ...
                <div class="box-header">
                  <h3 class="box-title">Out Of Stock Items Information</h3>
                </div><!-- /.box-header -->
                <div class="box-body">
					<?php echo $table;?>
					<a href="<?php echo base_url('reports/unavailableItems_csv');?>" class="btn btn-success "><i class="fa fa-fw fa-download"></i> <?php echo lang('export_csv');?></a>
				 </div><!-- /.box-body -->
              </div>
				</div>
